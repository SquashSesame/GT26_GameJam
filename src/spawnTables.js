...
const SPAWN_TABLES = {
  ...
  2: [
    { delay: 0.8, type: 'grunt', count: 7, hp: 2, algorithm: 'sine', image: 'boss_middle_usa.png' },
    { delay: 3.0, item: 'powerup' },
    { delay: 6.0, type: 'diver', count: 5, hp: 3, algorithm: 'zigzag', image: 'boss_middle_usa.png' },
    { delay: 9.0, item: 'powerup' },
    { delay: 12.0, type: 'diver', count: 5, hp: 3, algorithm: 'straight', params: { speedY: 130 }, image: 'boss_middle_usa.png' },
    { delay: 15.0, item: 'weapon', id: 'building' },
    { delay: 18.8, type: 'grunt', count: 7, hp: 2, algorithm: 'sine', image: 'boss_middle_usa.png' },
    { delay: 21.0, item: 'powerup' },
    { delay: 24.0, type: 'diver', count: 5, hp: 3, algorithm: 'zigzag', image: 'boss_middle_usa.png' },
    { delay: 27.0, item: 'powerup' },
    { delay: 30.0, type: 'diver', count: 5, hp: 3, algorithm: 'straight', params: { speedY: 130 }, image: 'boss_middle_usa.png' },
    { delay: 33.0, item: 'weapon', id: 'building' },
    { delay: 39.0, type: 'tank', count: 2, hp: 6, algorithm: 'bounce', image: 'boss_middle_usa.png' },
  ...
  3: [
    ...
    { delay: 21.6, type: 'diver', count: 8, hp: 3, algorithm: 'sine', image: 'enemy_space_rock.png' },
    { delay: 24.0, item: 'weapon', id: 'nuclear' },
    { delay: 27.0, type: 'tank', count: 3, hp: 5, algorithm: 'bounce', image: 'enemy_space_rock.png' },
    { delay: 30.0, item: 'powerup' },
    { delay: 33.0, type: 'diver', count: 6, hp: 3, algorithm: 'zigzag', image: 'enemy_space_rock.png' },
